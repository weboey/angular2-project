...
export const ComponentMenuNavItems: ComponentMenuNav[] = [
  ...
  {id: 7, name: 'tabs',label:"tab",level:2,parentLevelId:2,projectId:1},
  {id: 8, name: 'chart',label:"图形",level:2,parentLevelId:2,projectId:1},
  {id: 9, name: 'font',label:"字体",level:2,parentLevelId:2,projectId:1},
  ...
  {id: 15, name: 'inout',label:"输入框",level:2,parentLevelId:2,projectId:1},
